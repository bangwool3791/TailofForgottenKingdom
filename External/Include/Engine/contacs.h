...
namespace cyclone {
    ...
    protected:
        ...
        /**
         * A transform PhysXMatrix that converts co-ordinates in the contact's
         * frame of reference to world co-ordinates. The columns of this
         * PhysXMatrix form an orthonormal set of vectors.
         */
        PhysXMat3 contactToWorld;
    ...
    protected:
         ...
         * these anyway.
         */
        Vector3 calculateFrictionlessImpulse(PhysXMat3* inverseInertiaTensor);
         ...
         */
        Vector3 calculateFrictionImpulse(PhysXMat3* inverseInertiaTensor);
    };
