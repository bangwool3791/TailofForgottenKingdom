...
//}
//
//dtStatus NaviMeshMgr::init(const dtNavMeshParams* params)
//{
...
//	return DT_SUCCESS;
//}
//CGameObjectEx* NaviMeshMgr::loadAll(const wstring& path)
//{
...
//dtStatus NaviMeshMgr::addTile(unsigned char* data, int dataSize, int flags,
...
//
//
//const dtMeshTile* NaviMeshMgr::getTileAt(const int x, const int y, const int layer) const
//{
...
//}
//
//dtTileRef NaviMeshMgr::getTileRef(const dtMeshTile* tile) const
//{
//	if (!tile) return 0;
...
//}
//
//int NaviMeshMgr::getNeighbourTilesAt(const int x, const int y, const int side, dtMeshTile** tiles, const int maxTiles) const
//{
//	int nx = x, ny = y;
//	switch (side)
//	{
...
/////  @see #encodePolyId
//unsigned int NaviMeshMgr::decodePolyIdTile(dtPolyRef ref) const
//{
//#ifdef DT_POLYREF64
...
/////  @param[in]	ref		The polygon reference.
/////  @see #encodePolyId
//unsigned int NaviMeshMgr::decodePolyIdSalt(dtPolyRef ref) const
//{
//#ifdef DT_POLYREF64
...
//}
//
//void NaviMeshMgr::connectIntLinks(dtMeshTile* tile)
//{
//	if (!tile) return;
//
...
//}
//
//void NaviMeshMgr::baseOffMeshLinks(dtMeshTile* tile)
//{
//	if (!tile) return;
//
//	dtPolyRef base = getPolyRefBase(tile);
...
///// }
///// @endcode
//dtPolyRef NaviMeshMgr::getPolyRefBase(const dtMeshTile* tile) const
//{
//	if (!tile) return 0;
//	const unsigned int it = (unsigned int)(tile - m_tiles);
...
//}
//
//void NaviMeshMgr::connectExtOffMeshLinks(dtMeshTile* tile, dtMeshTile* target, int side)
//{
//	if (!tile) return;
//
...
//}
//
//dtPolyRef NaviMeshMgr::findNearestPolyInTile(const dtMeshTile* tile,
...
//}
//
//int NaviMeshMgr::queryPolygonsInTile(const dtMeshTile* tile, const float* qmin, const float* qmax,
...
//}
//
//void NaviMeshMgr::closestPointOnPoly(dtPolyRef ref, const float* pos, float* closest, bool* posOverPoly) const
//{
...
//int NaviMeshMgr::getTilesAt(const int x, const int y, dtMeshTile const** tiles, const int maxTiles) const
//{
//	int n = 0;
//
//	// Find tile based on hash.
...
//int NaviMeshMgr::getTilesAt(const int x, const int y,
...
//	return n;
//}
//void NaviMeshMgr::connectExtLinks(dtMeshTile* tile, dtMeshTile* target, int side)
//{
//	if (!tile) return;
//
...
//
////////////////////////////////////////////////////////////////////////////////////////////
//int NaviMeshMgr::findConnectingPolys(const float* va, const float* vb,
...
//}
//
//void NaviMeshMgr::getTileAndPolyByRefUnsafe(const dtPolyRef ref, const dtMeshTile** tile, const dtPoly** poly) const
//{
...
//}
//
//bool NaviMeshMgr::getPolyHeight(const dtMeshTile* tile, const dtPoly* poly, const float* pos, float* height) const
//{
