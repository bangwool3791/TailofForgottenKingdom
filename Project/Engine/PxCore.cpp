...
const PxVec3 PxVec3::GRAVITY = PxVec3(0, -9.81, 0);
const PxVec3 PxVec3::HIGH_GRAVITY = PxVec3(0, -19.62, 0);
const PxVec3 PxVec3::UP = PxVec3(0, 1, 0);
const PxVec3 PxVec3::RIGHT = PxVec3(1, 0, 0);
const PxVec3 PxVec3::OUT_OF_SCREEN = PxVec3(0, 0, 1);
const PxVec3 PxVec3::X = PxVec3(0, 1, 0);
const PxVec3 PxVec3::Y = PxVec3(1, 0, 0);
const PxVec3 PxVec3::Z = PxVec3(0, 0, 1);
