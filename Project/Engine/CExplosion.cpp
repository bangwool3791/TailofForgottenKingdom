...
CExplosion::CExplosion()
	:CParticleSystem(COMPONENT_TYPE::EXPLOSION)
{
...
CExplosion::CExplosion(COMPONENT_TYPE _type)
	:CParticleSystem(_type)
{
...
CExplosion::CExplosion(const CExplosion& _Rhs)
...
void CExplosion::SaveToFile(FILE* _File)
{
	__super::SaveToFile(_File);
}
void CExplosion::LoadFromFile(FILE* _File)
{
	__super::SaveToFile(_File);
}