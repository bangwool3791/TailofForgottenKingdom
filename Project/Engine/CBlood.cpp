...
CBlood::CBlood()
	:CParticleSystem(COMPONENT_TYPE::BLOOD)
{
...
CBlood::CBlood(COMPONENT_TYPE _type)
...
CBlood::CBlood(const CBlood& _Rhs)
...
void CBlood::SaveToFile(FILE* _File)
{
	__super::SaveToFile(_File);
}
void CBlood::LoadFromFile(FILE* _File)
{
	__super::SaveToFile(_File);
}