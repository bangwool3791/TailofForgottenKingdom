...
CDust::CDust()
	:CParticleSystem(COMPONENT_TYPE::DUST)
{
...
CDust::CDust(COMPONENT_TYPE _type)
...
void CDust::SaveToFile(FILE* _File)
{
	__super::SaveToFile(_File);
}
void CDust::LoadFromFile(FILE* _File)
{
	__super::SaveToFile(_File);
}