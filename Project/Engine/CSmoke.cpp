...
CSmoke::CSmoke()
	:CParticleSystem(COMPONENT_TYPE::SMOKE)
{
...
CSmoke::CSmoke(COMPONENT_TYPE _type)
...
CSmoke::CSmoke(const CSmoke& _Rhs)
...
void CSmoke::SaveToFile(FILE* _File)
{
	__super::SaveToFile(_File);
}
void CSmoke::LoadFromFile(FILE* _File)
{
	__super::SaveToFile(_File);
}